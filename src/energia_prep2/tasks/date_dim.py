...
from energia_prep2.cfg import settings  # DATE_START/DATE_END z .env
from energia_prep2.db import get_conn_app
...
def build() -> None:
    ...
    Meta kalendarzowa liczona w PL (bez trzymania ts_local w tabeli).
    """
    ...
    upsert_sql = """
        INSERT INTO input.date_dim (
          ts_utc, year, month, day, dow, hour, is_workday, is_holiday, holiday_name, granularity, dt_h
        )
