...
def test_iter_sql_files_order(tmp_path, monkeypatch):
    ...
    (root / "30_views" / "01_output_vw_energy_calc_input.sql").write_text("-- f", encoding="utf-8")
    ...
    # Oczekiwana kolejność „po folderach”: 00_init → 10_schemas → 20_tables → 30_views → 40_triggers → 90_finalize
    ...
    assert rel == [
        ...
        "30_views/01_output_vw_energy_calc_input.sql",
